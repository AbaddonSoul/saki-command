module.exports = (req, res) => {
  // Función para limpiar y formatear cada mención
  ...
  const u = formatearUsuario(req.query.usuario, 'Alguien');
  const o1 = formatearUsuario(req.query.o1, 'Tripulante1');
  const o2 = formatearUsuario(req.query.o2, 'Tripulante2');

  const historias = [
    `👨‍🚀 ${u} dijo: "Confíen en mí, yo sé manejar esto". Dos segundos después, la nave se partió a la mitad, mandó a ${o1} volando a Marte y dejó a ${o2} atrapado en el sol sin Wi-Fi.`,
    ...
    `🚀 En pleno viaje, ${u} puso cumbia a todo volumen. ${o1} se distrajo bailando en el panel central, ${o2} tiró el café sobre los motores y terminaron chocando contra un OXXO intergaláctico.`,
    ...
    `🛸 ${u} se distrajo comiendo pizza al volante, usó a ${o1} como escudo contra meteoritos y le quemó las cejas a ${o2} con el propulsor trasero.`,
